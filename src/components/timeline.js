    ...
    const visJsContainer = useRef(null);
      ...
      useEffect(() => {
        ...
        var datasetItems= new DataSet([
            ...
            { id: `item5`, group:2, content: `<img src='${Document}' style='width: 28px; height: 28px;'> <a href="" target="_blank">Alnylam Patent 1</a> `, editable: false, type:'range', className: "External", start: '2022-06-16', end: '2022-06-29', title: "hello alynylam"},
            ]);
